...
tf.flags.DEFINE_string('X_input_dir', 'data/training_images/'+FLAGS.project+'/'+FLAGS.type+'A',
                       'X input directory, default: data/apple2orange/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/training_images/'+FLAGS.project+'/'+FLAGS.type+'B',
                       'Y input directory, default: data/apple2orange/trainB')
                       
tf.flags.DEFINE_string('X_output_file', 'data/training_images/tfrecords/'+FLAGS.X+'.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/apple.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/training_images/tfrecords/'+FLAGS.Y+'.tfrecords',
