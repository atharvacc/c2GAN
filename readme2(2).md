...
|                          Input                          |                          CCGAN                          |                          GT                          |
| :-----------------------------------------------------: | :-----------------------------------------------------: | :--------------------------------------------------: |
| ![liver_whole_slide](images/liver_wholeslide_input.png) | ![liver_whole_slide](images/liver_wholeslide_CCGAN.png) | ![liver_whole_slide](images/liver_wholeslide_GT.png) |

|                    Input                     |                    CCGAN                     |                    GT                     |
| :------------------------------------------: | :------------------------------------------: | :---------------------------------------: |
| ![liver_whole_slide](images/liver_input.png) | ![liver_whole_slide](images/liver_CCGAN.png) | ![liver_whole_slide](images/liver_GT.png) |
